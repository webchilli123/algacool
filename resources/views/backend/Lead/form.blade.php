    ...
    <form action="{{ $form['url'] }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-2">
                <div class="row mb-2">
                    ...
                    <div class="col-md-5 mb-2" id="new-customer-fields" style="display: none;">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2">
                                <x-Inputs.text-field name="address" placeholder="Enter Party Address" class="form-control" :value="old('address', $model->address ?? '')"
                                    label="Address" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        <x-Inputs.drop-down name="lead_source_id" label="Source" :list="$sourceList" :value="old('lead_source_id', $model->lead_source_id ?? '')"
                    ...
                    <table class="table table-striped table-bordered order-column template-table"
                        ...
                        <tbody>
                            <tr class="sr-table-template-row hidden">
                                ...
                                <td>
                                    <x-Inputs.drop-down name="lead_items[item_id][]" label="" :list="$itemList"
                                        :value="old('lead_items.item_id', $model->item_id ?? '')" class="form-control will-require" />
                                </td>
                                <td>
