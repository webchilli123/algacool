 ...
 public function create()
    ...
    private function _common_validation_rules()
    {
        return [
            ...
            'lead_items.*.item_id' => 'required|integer|exists:items,id',
    ...
    private function _common_validation_rules_update()
    {
        return [
            ...
            'lead_source_id' => 'sometimes|required|integer|exists:sources,id',
            ...
            'lead_items.*.item_id' => 'required_with:lead_items|integer|exists:items,id',
